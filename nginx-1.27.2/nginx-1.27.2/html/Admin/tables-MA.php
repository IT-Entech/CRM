...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <li>
            <a href="tables-MA.php"class="active">
              <i class="bi bi-circle"></i><span>ตารางค่าซ่อม</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
                ...
                <div class="row">
                  <div class="col-xxl-3 col-md-4">
                    <div class="form-floating mb-3">
                      <select class="form-select" id="list-ma" aria-label="list-ma"onchange="fetchData()">
                        <option selected value="N">-</option>
                        <option value="V">ค่าซ่อมรถ</option>
                        <option value="C">ค่าซ่อมภาชนะ</option>
                      </select>
                      <label for="list-ma">รายการ</label>
                    </div>
                  </div>
                  <!--div class="col-xxl-3 col-md-4">
                    <div class="form-floating mb-3">
  ...
  <script src="assets/js/table-MA.js"></script>
</body>
